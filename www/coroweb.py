...
def get_required_kw_args(fn: object) -> object:
    args=[]
...
class RequestHandler(object):
    ...
    def __init__(self, app, fn):
        self._app = app
        self._func = fn
        self._has_requset_arg = has_request_arg()
        ...
        if self._has_var_kw_arg or self._has_named_kw_args or self._required_kw_args:
            if requset.method=='POST':
                ...
                if ct.startswith('application/json'):
                    ...
                    kw = params
                elif ct.startswith('applicationo/x-www-form-urlencoded') or ct.startswith('multipart/form-data'):
